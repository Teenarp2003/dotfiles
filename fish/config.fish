...
alias mirror="sudo reflector --country India -f 30 -l 30 --number 10 --verbose --save /etc/pacman.d/mirrorlist"
...
alias rm='rm -i'
alias mount-phone='sshfs -p 8022 u0_a412@192.168.1.103:/sdcard/ ~/Phone'
alias fzf='fzf -e'
